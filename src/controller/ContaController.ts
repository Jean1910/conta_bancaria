...
public depositar(numero: number, valor: number): void {
        ...
        if (conta != null) {
            ...
            console.log(`O Depósito na Conta numero: ${numero} foi efetuado com sucesso!`);
        } else {
            console.log(`A Conta numero: ${numero} não foi encontrada!`);
        }
    }
...
public transferir(numeroOrigem: number, numeroDestino: number, valor: number): void {
        ...
        if (contaOrigem != null && contaDestino != null) {
            if (contaOrigem.sacar(valor) === true) {
                ...
                console.log(`A Transferência da Conta ${numeroOrigem} para ${numeroDestino} foi efetuada com sucesso!`);
            }
        } else {
